<h2>Viewing <span class='muted'>#<?php echo $clearanceform->id; ?></span></h2>
...
<?php echo Html::anchor('clearanceform/edit/'.$clearanceform->id, 'Edit'); ?> |
<?php echo Html::anchor('clearanceform', 'Back'); ?>